...
public class RecentFilesProvider implements DynamicMenuProvider
{
	...
	public void update(JMenu menu)
	{
		...
		//{{{ ActionListener...
		ActionListener actionListener = (ActionEvent evt)->{ jEdit.openFile(view,evt.getActionCommand());
				view.getStatus().setMessage(null);}; //}}}

		//{{{ ChangeListener...
		ChangeListener changeListener = (ChangeEvent e)->{ JMenuItem menuItem = (JMenuItem) e.getSource();
