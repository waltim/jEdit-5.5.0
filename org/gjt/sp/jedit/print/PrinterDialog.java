...
public class PrinterDialog extends JDialog implements ListSelectionListener
{
    ...
    public void valueChanged( ListSelectionEvent e )
    {
        ...
        Arrays.sort(sizes, (MediaSizeName a, MediaSizeName b) -> a.toString().compareTo( b.toString() ));
        ...
        if (pagesPerSide != null)
        {
            ...
            else
            {
                ...
                Arrays.sort(numberUp, (NumberUp a, NumberUp b) -> {
                    int m = a.getValue();
                    int n = b.getValue();
                    if ( m < n )
                    {
    ...
    private class GeneralPanel extends PrinterPanel
    {
        ...
        public GeneralPanel()
        {
            ...
            allPages.addActionListener((ActionEvent ae) -> {
                pagesField.setEnabled( pages.isSelected() );
            });
            pages.addActionListener((ActionEvent ae) -> {
                pagesField.setEnabled( pages.isSelected() );
            });
            copies.addChangeListener((ChangeEvent e) -> {
    ...
    private class PageSetupPanel extends PrinterPanel
    {
        ...
        public PageSetupPanel()
        {
            ...
            // add listeners
            pagesPerSide.addActionListener((ActionEvent ae) -> {
            ...
            paperSize.addActionListener((ActionEvent ae) -> {
                PageSetupPanel.this.setDefaultMargins();
            });
            orientation.addActionListener((ActionEvent ae) -> {
                PageSetupPanel.this.setDefaultMargins();
            });
    ...
    private class JobPanel extends PrinterPanel
    {
        ...
        public JobPanel()
        {
            ...
            // add listeners
            atButton.addActionListener((ActionEvent ae) -> {
