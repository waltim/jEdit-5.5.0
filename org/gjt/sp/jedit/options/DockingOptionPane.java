...
public class DockingOptionPane extends AbstractOptionPane
{
	...
	private JPanel createDockingOptionsPanel()
	{
		...
		autoLoadModeLayout.addActionListener((ActionEvent e)->{ autoSaveModeLayout.setEnabled(autoLoadModeLayout.isSelected());});
		...
		dockableSetSelection.addItemListener((ItemEvent e)->{ windowModel.showSet((String) dockableSetSelection.getSelectedItem());});
		setSelection.add(Box.createHorizontalStrut(6));
